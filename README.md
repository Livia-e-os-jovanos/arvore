...
Aqui está um trecho **formal**, **objetivo** e adequado para um **README acadêmico**, explicando como compilar os arquivos `heapbinaria.c` e `bst.c` utilizando o GCC com a opção `-o`:
